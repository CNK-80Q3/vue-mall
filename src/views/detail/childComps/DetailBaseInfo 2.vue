<template>
  <div v-if="Object.keys(goodsBaseInfo).length !== 0" class="base-info">
    <div class="info-title">{{goodsBaseInfo.title}}</div>
    <div class="info-price">
      <span class="n-price">{{goodsBaseInfo.newPrice}}</span>
      <span class="o-price">{{goodsBaseInfo.oldPrice}}</span>
      <span class="discount">{{goodsBaseInfo.discount}}</span>
    </div>
    ...
    <div class="info-service">
      <span class="info-service-item" v-for="index in goodsBaseInfo.services.length-1" :key="index">
        <img :src="goodsBaseInfo.services[index-1].icon|Imgfilter" />
